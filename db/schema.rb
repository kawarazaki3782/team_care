...
ActiveRecord::Schema.define(version: 2021_08_17_150625) do
  ...
  create_table "templates", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
